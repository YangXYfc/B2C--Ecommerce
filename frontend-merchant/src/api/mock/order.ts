...
const orders: any[] = [
  { id: 1, orderNo: 'ORD20260707000001', totalAmount: 4999.00, payAmount: 4999.00, status: 3,
    ...
    items: [{ productName: '智选 Pro 5G 手机 12GB+256GB 钛空灰', skuName: '钛空灰 12GB+256GB', productImage: '/media/products/product-01-phone.jpg', quantity: 1, unitPrice: 4999.00, subtotal: 4999.00 }],
  ...
  { id: 2, orderNo: 'ORD20260707000002', totalAmount: 129.00, payAmount: 129.00, status: 1,
    ...
    items: [{ productName: '65W GaN氮化镓充电器 三口快充', skuName: '白色', productImage: '/media/products/product-04-charger.jpg', quantity: 1, unitPrice: 129.00, subtotal: 129.00 }],
  ...
  { id: 6, orderNo: 'ORD20260707000006', totalAmount: 4299.00, payAmount: 4299.00, status: 4,
    ...
    items: [{ productName: '轻薄本 Air 14 锐龙版 16GB+512GB', skuName: '16GB+512GB 银色', productImage: '/media/products/product-03-laptop.jpg', quantity: 1, unitPrice: 4299.00, subtotal: 4299.00 }],
  ...
  { id: 4, orderNo: 'ORD20260707000004', totalAmount: 1599.00, payAmount: null, status: 0,
    ...
    items: [{ productName: '畅享 Note 5G 手机 8GB+128GB 幻夜黑', skuName: '幻夜黑 8GB+128GB', productImage: '/media/products/product-02-phone.jpg', quantity: 1, unitPrice: 1599.00, subtotal: 1599.00 }],
    createdAt: '2026-07-07 08:00:00' },
  { id: 5, orderNo: 'ORD20260707000005', totalAmount: 59.00, payAmount: null, status: 5, cancelReason: '不想买了',
    addressSnapshot: { name: '张三', phone: '13800000004', province: '北京市', city: '北京市', district: '朝阳区', detail: '建国路88号现代城SOHO 1号楼1801室' },
    logisticsCompany: null, logisticsNo: null,
    items: [{ productName: '纯棉短袖T恤 男款 100%新疆棉', skuName: '白色 L', productImage: '/media/products/product-05-tshirt.jpg', quantity: 1, unitPrice: 59.00, subtotal: 59.00 }],
