...
onMounted(async () => {
  try {
    ...
    banners.value = bannerValues; categories.value = categoryValues; products.value = page.records
...
.hero { height: 380rpx; background: #fff; }
...
.feature { position: relative; height: 250rpx; overflow: hidden; border-radius: 20rpx; background: #f4efe9; }
.feature image { position: absolute; top: 0; right: 0; width: 58%; height: 100%; }
...
.grid { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 12rpx; margin-top: 18rpx; }
</style>
